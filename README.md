@liqd/ckeditor5-accordion
=========================

Accordion plugin for ckeditor5. This only works in combination with a django
template tag. See
https://github.com/liqd/adhocracy4/blob/main/adhocracy4/ckeditor/templatetags/ckeditor_tags.py.
...
The `@liqd/ckeditor5-accordion` package is available under [AGPL-3.0-only](https://www.gnu.org/licenses/agpl-3.0.en.html).
